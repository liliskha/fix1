...
ki2 = LINETCR.LINE()
ki2.login(token="EmzmH7udVEsmMlnMYpI7.EEbmd/OLTc2Uu8OPqO1pXW.tidPXar9tPRJqAUeE/LzKRqLrvTDINwU49v0iLupgT0=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmWrTidFo11WyXd7hATb.3ZPYZKPkms/HbQTtAV24/W.GjHNCUNE+W+XJ+nKtqDu0KuXzWdB7tWlDEPLogFpdCk=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmVH7b6tTY5ima1LNkE2.752/iGy+YeEbmgsDur71SG.UVvenn4S3nlIF6MRI7ME0ywEb8IAWsukCYmbwKqxaDg=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Emlh6lHcWR6UyxhWBpdd.zfQ3ZbkGgwAclgq1I5i8Vq.jguoPfmn741Z6tS5dU8wqmFvUJC7j8ZCMHC7ZiLYCG0=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="Emf1V9nZhoUngaDVN536.Wu+hErYx54kx/IkHj4IB1G.asxEWkRRT11f0GIPkH0bxrfdhBwnykTbVGqYdhkU1nU=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EmTin5KtderJBHS2tvjc.s80ZJQcHs0kVH2UrrWnxRa.hoMYQZZd289apkSPF6ztVZficHvUrGPN2mDCALKY+gU=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EmWDDhOqXXEfaL8R9Y1f.ZNZPIvbifOu1q1RqGxbSNW.P1fWpIaNQzPBYfJIBWnUkwL/xrKQ8+/wo9jKm0Hnfq4=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token="EmeTQmobq0Bn8rHdmEjf.jkY/3RNpjZoLKf01uOJnhW.9M4iVLq1bwvK+tz3V5bjzO0ht0A0Hd03ncZrjgv+b7I=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EmrYHRXtoZKiv1RURD28.jg64tnZskGmUCUlS2WBhUa.2nGDAfW0y90XdcssQ08Z8RqSTrqL/DJ8S5SHkrHGMw0=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EmCosn2ytJ97Aep9g95b.hNWWjQSkTuCL0keTRXEKYW.10U/P0Pf5rCInDf4rJMcZka+SUjGirYvdSTqQ4g9dgc=")
ki11.loginResult()

ki12 = LINETCR.LINE()
ki12.login(token="EmwULXJps2tDxEKWdpx0.x9EiHwGGldfaqJun9DrHia.6UKlboho829JSWE0VbjtVXCv1vXkVLcpQ32SwsviIyU=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EmWlBVWJq73puRVYrQ39.ZqmViVwER0Hv4fGc0YIVIq.tSvkhGwRLF9W9fOs9pJfcAr0xzfDtbMn7UqxCGuEB/M=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="Emod8ZStdLKZH9PuFZt4.u4A4JTfYGVA5KmAdEVqYHa.1NJJB9D2pfxdUg1kCvFFKRJmQnUB/5I6OW75n6oZKp4=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="EmanKdpqZvs2sju1cru4.tmA6TJR161yfGaMk5mYcDa.rIVDl32u0d4Z17hy3ejFiU2BjW2XPSUAj+AyRDdJDhM=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="EmBRACQ0Q8fAD0hzhpD3.WfmPD0b4d7TuqTgct4oaSW.54B+ccoe6X7Wf4QcxS6Dgtm9NyByERLdnMXlOdlMZxU=")
ki16.loginResult()

ki17 = LINETCR.LINE()
ki17.login(token="EmaGzyI8QWVUqcC76qH0.OFOKUI5ShWyQWkWcsi5P0a.MKGZX+4AA36Fwhb62UtSUalkzdY9nysBtx58Kkfd7Lw=")
ki17.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="EmiCGPTP5FM9sMed4B71.oeWYLEz8/aMXdOxGyrfYuq.CmWDsPOIdAblMdYak3h1Nz8B7lsnZX4Jlby8XV/q9Ag=")
ki18.loginResult()
...
admsa = "u9d498bad444f96197f182055d27a733d"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u9d498bad444f96197f182055d27a733d":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == 'Zet':
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif msg.text.lower() == 'Dbot':
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
...
#--------------------------------------------------------
                ...
                for i in gid:
                    ...
                    ki18.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"T&Z PSD TEAM BOT PAMIT DULU YEKAN")
                else:
...
#-----------------------------------------------------------
            ...
            elif "Tangkis" in msg.text:
                if msg.toType == 2:
                        print "[Command]Cleanse executing"
                        _name = msg.text.replace("Tangkis","")
                        gs = cl.getGroup(msg.to)
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                klist=[ki18,ki17,ki16,ki15,ki14,ki13,ki12,ki11,ki10,ki9,ki8,ki7,ki6,ki5,ki4,ki3,ki2,ki,cl]
                                kicker=random.choice(klist)
                                random.choice(KAC).kickoutFromGroup(msg.to,[target])
                                print (msg.to,[g.mid])
                            except:
...
#-----------------------------------------------------------speed
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n [â˜¸]âž¦Powered By: ZETSUã€…â€¢â”…â”€â”€â”€â”€â”€" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#-----------------------------------------------
                        ...
                        ki18.updateGroup(G)
#-----------------------------------------------
            elif msg.text.lower() == 'Psd bye.':
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"􀠁􀆩􏿿Bye Bye􀠁􀆩􏿿 "  +  str(ginfo.name)  + "")
